...
#doing we are learning to use division operator

#G
x = float(input("what's the value of x :- "))
y = float(input("what's the value of y :- "))
# here we will divide x  by  y
z =(x / y)
...
x = float(input("what's the value of x :- "))
y = float(input("what's the value of y :- "))
# here the value will be round up to places after division
z =round(x / y , 2)

print(z)

# I
# now we are going to do the same thing we did up there but instesd with the help of format string
x = float(input("what's the value of x :- "))
y = float(input("what's the value of y :- "))
# here the value will be round up to the nearest integer
z =(x / y)
